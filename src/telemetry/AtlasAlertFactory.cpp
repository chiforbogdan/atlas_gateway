...
const uint16_t ATLAS_PUSH_ALERT_PACKETS_PER_MINUTE_RATE_SEC_DEFAULT = 90;
...
const std::string ATLAS_THRESHOLD_ALERT_PACKETS_PER_MINUTE_THRESHOLD_DEFAULT = "1000";
