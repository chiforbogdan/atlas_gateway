...
int main(int argc, char **argv)
{
    ...
    atlas::AtlasCoapClient::getInstance().setDtlsInfo("test1111", "12345");

    uint8_t reqPayload[30];
    memset(reqPayload, 'A', 30);
    atlas::AtlasCoapClient::getInstance().sendRequest("coaps://127.0.0.1:10002/test/test_get", atlas::ATLAS_COAP_METHOD_GET, reqPayload,
                                                      30, 5000, test_get);


    memset(reqPayload, 'B', 30);
    atlas::AtlasCoapClient::getInstance().sendRequest("coaps://127.0.0.1:10002/test/test_post", atlas::ATLAS_COAP_METHOD_POST, reqPayload,
                                                      30, 5000, test_post);


    memset(reqPayload, 'C', 30);
    atlas::AtlasCoapClient::getInstance().sendRequest("coaps://127.0.0.1:10002/test/test_put", atlas::ATLAS_COAP_METHOD_PUT, reqPayload,
                                                      30, 5000, test_put);

    memset(reqPayload, 'D', 30);
    atlas::AtlasCoapClient::getInstance().sendRequest("coaps://127.0.0.1:10002/test/test_del", atlas::ATLAS_COAP_METHOD_DELETE, reqPayload,
                                                      30, 5000, test_del);
    
    atlas::AtlasCoapClient::getInstance().sendRequest("coaps://127.0.0.1:10003/test/test_del1", atlas::ATLAS_COAP_METHOD_DELETE, reqPayload,
                                                    30, 5000, test_del);
